...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        private void UpdateAssetStatus(int assetId, string statusToSet)
        {
            ...
            item.Status = _context.Statuses
                .FirstOrDefault(status => status.Name == statusToSet);
        }
        ...
        public void CheckInItem(int assetId)
        {
            ...
            // clsoe any existing checkout history
            CloseExistingCheckoutHistory(assetId, now);
        ...
        public void PlaceHold(int assetId, int libraryCard)
        {
            ...
            var card = _context.LibraryCards
                .FirstOrDefault(c => c.Id == libraryCard);
